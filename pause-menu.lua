...
local pauseMenuLevelOptions = {
    ...
    {name = "Round Start"   , func = start_var},
    {name = "Round Reset"   , func = reset_var},
    {name = "Round Skip"    , func = skip_var},
    {name = "Round End"     , func = stop_var},
	{name = "Coop Settings" , func = coop_var},
	{name = "Flood Menu"    , func = menu_var}
}
...
if _G.charSelectExists then
    ...
    djui_popup_create("You can open the CS Screen in the Menu", 2)
	end
end
...
local function hud_render()
    ...
    if _G.charSelectExists then
        ...
        for _, option in ipairs(pauseMenuLevelOptions) do
            if option.name == "Char" then
                csOptionExists = true
                break
            end
        end
        if not csOptionExists then
            table.insert(pauseMenuLevelOptions, {name = "Char", func = open_cs})
        end
